...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
          create: (context) => di.sl<SellerPackageController>()),
      // Provides the premium search and homepage promotion quotas to their seller-only screen.
      ChangeNotifierProvider(
          create: (context) => di.sl<SellerPromotionController>()),
      ...
      ChangeNotifierProvider(
          create: (context) => di.sl<ShowBottomSheetController>()),
      ChangeNotifierProvider(create: (context) => di.sl<TutorialController>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<AddProductTaxController>()),
      ...
      ChangeNotifierProvider(
          create: (context) => di.sl<AddAuctionProductController>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<AddAuctionProductMediaController>()),
      ChangeNotifierProvider(create: (context) => di.sl<AuctionAiController>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<AuctionProductController>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<AuctionTransactionController>()),
    ],
    child: _GlobalScrollListener(child: MyApp(body: body)),
  ));
}
            ...
            return MediaQuery(
              ...
              child: Stack(children: [
                ...
                if (Provider.of<AuthController>(context, listen: false)
                    ...
                    (100 !=
                        (shopController.shopModel?.setupGuideApp?.values
                                    .where((v) => v == 1)
                                    .length ??
                                0) /
                  ...
                  Selector<ShowBottomSheetController, bool>(
                      ...
                      builder: (_, isBottomSheetOpen, __) {
                        return (!isBottomSheetOpen ||
                                TutorialDialogController().isDialogOpen)
                            ? Positioned.fill(
                                child: Align(
                                                          ...
                                                          ? Container(
                                                              ...
                                                              decoration:
                                                                ...
                                                                borderRadius:
                                                                    BorderRadius
                                                                        .only(
                                                                  topRight: Radius.circular(TutorialDialogController()
                                                                              .isDialogOpen &&
                                                                          isLtr
                                                                      ? Dimensions
                                                                          .radiusDefault
                                                                      : 0),
                                                                  topLeft: Radius.circular(TutorialDialogController()
                                                                              .isDialogOpen &&
                                                                          isLtr
                                                                      ? 0
                                                                      : Dimensions
...
class _BottomSheetObserver extends NavigatorObserver {
  ...
  void _updateState() {
    ...
    final controller =
        Provider.of<ShowBottomSheetController>(context, listen: false);
    hasActiveOverlay
